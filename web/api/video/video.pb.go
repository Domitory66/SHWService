...
func (x *ImageRequest) GetIp() string {
	if x != nil {
		return x.Ip
	}
	return ""
...
func (x *ImageRequest) GetPort() string {
	if x != nil {
		return x.Port
	}
	return ""
...
func (x *ImageResponse) GetIp() string {
	if x != nil {
		return x.Ip
	}
	return ""
...
func (x *ImageResponse) GetPort() string {
	if x != nil {
		return x.Port
	}
	return ""
...
func (x *StopRequest) GetIp() string {
	if x != nil {
		return x.Ip
	}
	return ""
...
func (x *StopRequest) GetPort() string {
	if x != nil {
		return x.Port
	}
	return ""
...
func (x *StopResponse) GetIp() string {
	if x != nil {
		return x.Ip
	}
	return ""
...
func (x *StopResponse) GetPort() string {
	if x != nil {
		return x.Port
	}
	return ""
...
var file_video_video_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x32, 0x0a, 0x0c, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x09, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x22, 0x49, 0x0a, 0x0d, 0x49, 0x6d, 0x61, 0x67, 0x65,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x14, 0x0a, 0x05,
	0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x69, 0x6d, 0x61,
	0x67, 0x65, 0x22, 0x31, 0x0a, 0x0b, 0x53, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x04, 0x70, 0x6f, 0x72, 0x74, 0x22, 0x4c, 0x0a, 0x0c, 0x53, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x73,
	...
	,
...
var file_video_video_proto_depIdxs = []int32{
	0, // 0: VideoStream.GetVideoFromCamera:input_type -> ImageRequest
	2, // 1: VideoStream.StopVideoStream:input_type -> StopRequest
	1, // 2: VideoStream.GetVideoFromCamera:output_type -> ImageResponse
	3, // 3: VideoStream.StopVideoStream:output_type -> StopResponse
